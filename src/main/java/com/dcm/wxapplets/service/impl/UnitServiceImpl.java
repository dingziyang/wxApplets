...
import com.dcm.wxapplets.dao.UnitDao;
...
public class UnitServiceImpl extends BaseServiceImpl<Unit,UnitExample,Long> implements UnitService {
	...
	public int deleteByIds(List<Long> ids){
		...
		// 删 【用户-单位】 关联表
//		LUserUnitExample example = new LUserUnitExample();
//		example.createCriteria().andUnitidIn(ids);
//		this.lUserUnitDao.deleteByExample(example);
